 ...
 * restores the requested snapshot, and a field whose committed value is already
 * identical to the requested value sees no `value` change, so its effect does not
